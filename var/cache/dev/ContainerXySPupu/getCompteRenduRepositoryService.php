...
// Returns the private 'App\Repository\CompteRenduRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CompteRenduRepository.php';

return $this->privates['App\\Repository\\CompteRenduRepository'] = new \App\Repository\CompteRenduRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
