...
class __TwigTemplate_f1236e42ed78833fb9207cf8e47e346b2a4fbc4956388144f2be212a93c96172 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["request"] ?? null), "query", [], "any", false, false, false, 119), "get", [0 => "query"], "method", false, false, false, 119)]));
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["manager"] => $context["classes"]) {
            // line 393
            echo "        ";
            if ((twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "managers", [], "any", false, false, false, 393)) > 1)) {
                // line 394
                echo "            <h3>";
...
";
    ...
    {
        return new Source("", "@Doctrine/Collector/db.html.twig", "/Users/vellacyril/PhpstormProjects/arcades/vendor/doctrine/doctrine-bundle/Resources/views/Collector/db.html.twig");
    }
}
