...
// Returns the private 'App\Repository\FormulaireParticipantRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/FormulaireParticipantRepository.php';

return $this->privates['App\\Repository\\FormulaireParticipantRepository'] = new \App\Repository\FormulaireParticipantRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
