...
// Returns the private 'App\Repository\CitoyenRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CitoyenRepository.php';

return $this->privates['App\\Repository\\CitoyenRepository'] = new \App\Repository\CitoyenRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
