...
// Returns the private 'App\Repository\PetitionRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/PetitionRepository.php';

return $this->privates['App\\Repository\\PetitionRepository'] = new \App\Repository\PetitionRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
