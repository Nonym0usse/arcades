...
class Product extends \App\Entity\Product implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Product' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Product' . "\0" . 'name', '' . "\0" . 'App\\Entity\\Product' . "\0" . 'description', '' . "\0" . 'App\\Entity\\Product' . "\0" . 'image', '' . "\0" . 'App\\Entity\\Product' . "\0" . 'imageFile', '' . "\0" . 'App\\Entity\\Product' . "\0" . 'dates'];
        }
    ...
    public function setDates($date)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDates', [$date]);

        return parent::setDates($date);
    }
