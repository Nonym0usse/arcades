...
// Returns the private 'App\Repository\PetitionParticipantRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/PetitionParticipantRepository.php';

return $this->privates['App\\Repository\\PetitionParticipantRepository'] = new \App\Repository\PetitionParticipantRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
