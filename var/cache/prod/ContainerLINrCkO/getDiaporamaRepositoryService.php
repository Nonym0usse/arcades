...
// Returns the private 'App\Repository\DiaporamaRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/DiaporamaRepository.php';

return $this->privates['App\\Repository\\DiaporamaRepository'] = new \App\Repository\DiaporamaRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
