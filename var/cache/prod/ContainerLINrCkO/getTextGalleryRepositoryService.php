...
// Returns the private 'App\Repository\TextGalleryRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/TextGalleryRepository.php';

return $this->privates['App\\Repository\\TextGalleryRepository'] = new \App\Repository\TextGalleryRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
