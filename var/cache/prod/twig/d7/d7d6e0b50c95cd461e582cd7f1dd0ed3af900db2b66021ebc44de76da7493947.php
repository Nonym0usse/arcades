...
class __TwigTemplate_954b5d35ff66bd5a2e7ad6b9b62ac31f59aad56d7f52b1d16fd1f8ab2766bdc9 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["id"] ?? null)]);
    ...
    public function block_form_rows($context, array $blocks = [])
    {
        ...
        // line 408
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable(twig_array_filter($this->env, ($context["form"] ?? null), function ($__child__) use ($context, $macros) { $context["child"] = $__child__; return  !twig_get_attribute($this->env, $this->source, $context["child"], "rendered", [], "any", false, false, false, 408); }));
        foreach ($context['_seq'] as $context["_key"] => $context["child"]) {
            // line 409
            echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($context["child"], 'row');
        }
...
$context["attrvalue"] === false)) {
    ...
    {
        return new Source("", "form_div_layout.html.twig", "/Users/vellacyril/PhpstormProjects/arcades copie 2/vendor/symfony/twig-bridge/Resources/views/Form/form_div_layout.html.twig");
    }
}
